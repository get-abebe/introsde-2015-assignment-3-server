...
import introsde.assignment.model.MeasureDefaultRange;
...
public class MeasureDefinition implements Serializable {
	...
	public MeasureDefinition getMeasure(String name) {
		for (MeasureDefinition def : this.getAll()) {
			if(def.getMeasureName()== name)
				return def;
		}
		return null;
	}
